...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from '@/shared/ui/animate-ui/components/animate/tooltip'
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
const sidebarMenuButtonActiveVariants = cva(
  'bg-[linear-gradient(to_bottom_right,rgba(137,190,255,0.22),rgba(137,190,255,0.85))] text-neutral-900 dark:text-neutral-50 rounded-md ring-1 ring-inset ring-[#89BEFF]/30',
  {
    variants: {
      variant: {
        default:
          'bg-[linear-gradient(to_bottom_right,rgba(137,190,255,0.22),rgba(137,190,255,0.85))] text-neutral-900 dark:text-neutral-50',
        outline:
          'bg-[linear-gradient(to_bottom_right,rgba(137,190,255,0.28),rgba(137,190,255,0.9))] text-neutral-900 dark:text-neutral-50 shadow-[0_0_0_1px_rgba(137,190,255,0.35)]',
      },
    },
    defaultVariants: {
      variant: 'default',
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button relative flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        default: '',
